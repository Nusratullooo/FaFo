jQuery(function ($) {
    ...
    $('.menu-details-carousel').slick({
        ...
        responsive: [{
            breakpoint: 991,
            settings: {centerPadding: '180px', slidesToShow: 1, slidesToScroll: 1,}
        }, {breakpoint: 767, settings: {centerPadding: '0px', slidesToShow: 1, slidesToScroll: 1,}},]
    });
    ...
    $("#range-slider").slider({
        range: true, min: 40, max: 400, values: [40, 400], slide: function (event, ui) {
